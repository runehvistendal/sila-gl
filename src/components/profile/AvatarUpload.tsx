...
export default function AvatarUpload({ fullName, initialAvatarUrl }: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      ...
      <button
        ...
        disabled={uploading}
        className="relative rounded-full border-2 overflow-hidden flex items-center justify-center shrink-0 transition-opacity focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[#09192A] focus-visible:ring-[#4A9CC7] disabled:opacity-70 group"
        style={{
          width: SIZE_PX,
          height: SIZE_PX,
          borderColor: "#4A9CC7",
      ...
      >
        ...
        {!uploading && (
          ...
          >
            <Camera className="w-8 h-8" style={{ color: "#4A9CC7" }} aria-hidden />
          </span>
        )}
      </button>
